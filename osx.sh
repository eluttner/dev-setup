...
#### TODO defaults write com.apple.BluetoothAudioAgent "Apple Bitpool Min (editable)" -int 40
...
mkdir ${HOME}/Dropbox/Pictures/Screenshots
defaults write com.apple.screencapture location -string "${HOME}/Dropbox/Pictures/Screenshots"
